...
Source-of-truth for ``IST``, ``DB_PATH``, ``Settings``, and the ``settings``
singleton. Re-exported by :mod:`bot.config` for back-compat — new code
should import from here directly so it doesn't pull in the bot package.
